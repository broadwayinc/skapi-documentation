...
Skapi provides API bridge to your custom API's.
You can build your own API's from your own server and let your users securely connect to your API via Skapi.
